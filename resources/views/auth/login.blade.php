	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #213555">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" method="POST" action="{{ route('login') }}">
								...
								<div class="fv-row mb-10">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" name="username" :value="old('email')" autocomplete="off" />
								</div>
								<div class="fv-row mb-10">
