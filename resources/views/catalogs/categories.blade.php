...
@section('title_top', 'Categorias')
@section('catalogs', 'active')
@section('subtitle_top', 'Control de Categorias')
@section('content')
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-category-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Buscar categorys" />
                    </div>
                </div>
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-category-table-toolbar="base">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_category">Agregar Categoría</button>
                    </div>
                    <div class="d-flex justify-content-end align-items-center d-none"
                        data-kt-category-table-toolbar="selected">
                        <div class="fw-bolder me-5">
                            <span class="me-2" data-kt-category-table-select="selected_count"></span>Seleccionados
                        </div>
                        <button type="button" class="btn btn-danger"
                            data-kt-category-table-select="delete_selected">Borrar Seleccionados</button>
                    </div>
                </div>
            </div>
                            ...
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true"
                                        data-kt-check-target="#kt_categorys_table .form-check-input" value="1" />
                                </div>
                            </th>
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    <form class="form" action="#" id="kt_modal_add_category_form"
                        data-kt-redirect="../../demo6/dist/apps/categorys/list.html">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_category_scroll" data-kt-scroll="true"
                                ...
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-bold mb-2">Nombre Categoría</label>
                                    <input type="text" class="form-control form-control-solid" placeholder="Ingresa un nombre" name="name" id="name" />
                                    <input type="text" class="form-control form-control-solid d-none" name="id_category" id="id_category" />
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-bold mb-2">Descripción</label>
                                    <input type="text" class="form-control form-control-solid" placeholder="Ingresa una breve descripción de la categoría" name="description" id="description" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer flex-center">
                            <button type="button" id="kt_modal_add_category_cancel"
