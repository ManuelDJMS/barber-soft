            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-role-table-toolbar="base">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_role">Agregar Rol</button>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    <form class="form" action="#" id="kt_modal_add_role_form"
                        data-kt-redirect="../../demo6/dist/apps/roles/list.html">
...
@section('scripts')
    ...
    <script src="{{asset('assets/js/catalogs/roles.js')}}"></script>
@endsection
